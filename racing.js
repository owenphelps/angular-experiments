...
.factory('Races', function($http) {
    ...
    $http.get("http://owenphelps.pythonanywhere.com/racing/api/fixtures").success(function(data) {
        obj.fixtures = data;
    });
...
.factory('raceSelectionService', function() {
    return {
        race: null
    };
})
.factory('fixtureSelectionService', function() {
    return {
        fixture: null
    };
})
...
.controller('FixturesCtrl', ['$scope', 'Races', 'filterService', 'raceSelectionService', 'fixtureSelectionService',
...
.controller('AssignmentCtrl', ['$scope', 'People', 'Races', 'raceSelectionService', 'fixtureSelectionService',
...
.controller('DashboardCtrl', ['$scope', 'People', 'Races',
